...
namespace Library_Management
{
	...
	public class Actions : System.Windows.Forms.Form
	{
		...
		public Actions()
		{
			...
			InitializeComponent();
            {
                SqlConnection inst=new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Home\Documents\library.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True");
			//
